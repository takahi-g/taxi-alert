...
function updateTrainDelays() {
    ...
    const delayInfo = {
        ...
        active: true,
        title: '⚠️ 鉄道運行情報',
        body: `西鉄天神大牟田線（二日市〜太宰府間）にて、踏切内安全確認の影響で <strong style="color:red;">運転見合わせ</strong>！西鉄二日市駅にてタクシー需要が急増します。`,
        soundText: '鉄道運行情報です。西鉄天神大牟田線が運転見合わせ中です。西鉄二日市駅にてタクシー需要が急増しています。周辺に向かってください。',
        lat: 33.5002,
        lon: 130.5168,
        popupHtml: `
            <strong style="color:red; font-size: 1.1em;">⚠️ 運転見合わせ中</strong><br>
            <b>西鉄二日市駅 周辺</b><br>
            列車の運休により、タクシー乗り場が大混雑しています。<br>
            <a href="https://www.google.com/maps/dir/?api=1&destination=33.5002,130.5168" target="_blank" class="nav-btn" style="background:#d32f2f;">📍 駅へ向かう</a>
        `
    };
    ...
    if (delayInfo.active && !isTrainDelayActive) {
        ...
        // 上部のスクロールバナーも表示
        if (banner) {
            banner.innerHTML = `⚠️ <b>西鉄天神大牟田線</b> (二日市〜太宰府間) - 踏切内安全確認の影響で <b><span style="color: yellow;">運転見合わせ</span></b>！`;
